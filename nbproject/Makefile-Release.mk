...
${OBJECTDIR}/Darlehen.o: Darlehen.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Darlehen.o Darlehen.cpp

${OBJECTDIR}/Darlehensverwaltung.o: Darlehensverwaltung.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Darlehensverwaltung.o Darlehensverwaltung.cpp
...
${OBJECTDIR}/Haus.o: Haus.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Haus.o Haus.cpp
...
${OBJECTDIR}/Kundenverwaltung.o: Kundenverwaltung.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Kundenverwaltung.o Kundenverwaltung.cpp

${OBJECTDIR}/Sicherheit.o: Sicherheit.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Sicherheit.o Sicherheit.cpp

${OBJECTDIR}/Sicherungsverwaltung.o: Sicherungsverwaltung.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Sicherungsverwaltung.o Sicherungsverwaltung.cpp

${OBJECTDIR}/Wertanlage.o: Wertanlage.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Wertanlage.o Wertanlage.cpp

${OBJECTDIR}/Zahlungsverwaltung.o: Zahlungsverwaltung.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Zahlungsverwaltung.o Zahlungsverwaltung.cpp
